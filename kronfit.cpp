...
int main(int argc, char* argv[]) 
{
	...
	Try
		...
		fstream myfile("InputGraphs.txt");
		...
		{   
			...
			while (getline(myfile,line) )  // Iterate over all networks in the input file
			{	fileC++;
				fileC1++;
				GotoLine(myfile, fileC);
				
				//while(getline(mypara,paraline)) // Iterate over all parameters in the input file
				//{   
				string paraline;
				mypara >> paraline;
				cout << paraline;
